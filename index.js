...
const app = express();
// Trust proxy para obtener ip correcta detrás de proxies (Render, Heroku, Cloudflare)
...
// Anti-fraud: register fingerprint usage
...
// Core handler when payment is confirmed (via create flow OR webhook)

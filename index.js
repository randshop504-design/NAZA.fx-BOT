...
const SUCCESS_URL = process.env.SUCCESS_URL || 'https://discord.com/channels/' + GUILD_ID;
...
async function checkAndRegisterCard({ card_fingerprint, card_last4, card_type, membership_id }){
  ...
  try{
    ...
    if (existing) {
      // Verificar si ya está asociada a este membership_id
      const already_linked = (existing.membership_ids || []).includes(membership_id);

      if (already_linked) {
        // Es una renovación del mismo usuario - NO incrementar contador
      ...
      // Tarjeta usada en nuevo membership_id
      ...
      <td style="padding:20px 30px;background:rgba(0,255,255,0.03);border-top:1px solid #1e2847;border-bottom:1px solid #1e2847;">
        ...
        <ol style="margin:0;padding-left:20px;color:#b7c9e8;font-size:14px;line-height:1.8;">
          <li style="margin-bottom:12px;">
            ...
            <a href="https://discord.com/download" style="color:#4d9fff;text-decoration:none;">👉 Descargar para Windows/Mac/Linux</a><br>
            <a href="https://play.google.com/store/apps/details?id=com.discord" style="color:#4d9fff;text-decoration:none;">👉 Descargar para Android</a><br>
            <a href="https://apps.apple.com/app/discord/id985746746" style="color:#4d9fff;text-decoration:none;">👉 Descargar para iOS</a>
          </li>
          <li style="margin-bottom:12px;">
            <strong style="color:#00ffff;">Mira este tutorial:</strong><br>
            <a href="https://www.youtube.com/watch?v=TJ13BA3-NR4" style="color:#4d9fff;text-decoration:none;">🎥 Tutorial Discord en Español</a>
          </li>
          <li style="margin-bottom:12px;">
            <strong style="color:#00ffff;">Haz clic en el botón de arriba</strong> para unirte automáticamente a nuestro servidor
          </li>
        </ol>
      </td>
    </tr>
    ...
    <tr>
      <td style="padding:30px 30px 20px;color:#8a9ab8;font-size:13px;">
        <p style="margin:0 0 10px;">
          <strong style="color:#00ffff;">Tu ID de Membresía:</strong> ${escapeHtml(membership_id)}
        </p>
        <p style="margin:0 0 10px;">
    ...
    <tr>
      <td align="center" style="padding:20px;background:#070b14;color:#5a6b8a;font-size:12px;line-height:1.6;">
        ...
        <p style="margin:0;color:#3a4b6a;">
          © 2024 NAZA Trading Academy. Todos los derechos reservados.
        </p>
      </td>
    </tr>
...
app.post('/api/payment/process', async (req, res) => {
  ...
  try {
    ...
    // Verificar tarjeta (antifraude mejorado)
...
// ============================================
// ENDPOINT: Check Payment Status (para polling)
// ============================================

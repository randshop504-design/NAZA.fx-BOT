...
function buildTrainingEmailHtml({ name, email }) {
  const logoPath = 'https://vwndjpylfcekjmluookj.supabase.co/storage/v1/object/public/assets/0944255a-e933-4527-9aa5-f9e18e862a00.jpg';
    ...
    <table width="100%" bgcolor="#000000">
      <tr>
        <td align="center">
          ...
          <table width="680" style="max-width:680px;background:#111;border-radius:12px;padding:30px;color:white;font-family:Arial,sans-serif;">

            <tr>
              <td align="center">
                <img src="${logoPath}" width="96" height="96" style="border-radius:50%;">
            ...
            <tr>
              <td>
                ...
                <p><strong>Paso 1: Crear tu cuenta de Discord</strong></p>

                <p>
                https://youtu.be/8JWq4zbffHY?si=lkcqrNuJBlJxQWfn
                </p>

                <p><strong>Paso 2: Aprender a utilizar Whop</strong></p>
...
async function sendTrainingEmail(email, name) {
  ...
  const html = buildTrainingEmailHtml({
    name,
    email
  });
